...
DISTRO="${DISTRO:-$1}"
TAG="${TAG:-$2}"
FQIN="docker.io/lsm5/travis_${DISTRO}:${TAG}"
SPCCMD="${SPCCMD:-./hack/spc_build_$1.sh}"
...
ENV_ARGS="-e HOME=/home/lsm5-bot -e SHELL=/bin/bash -e SPC=true -e DISTRO=$DISTRO -e WORKDIR=$WORKDIR -e FEDORA_KRB_PASSWORD=$FEDORA_KRB_PASSWORD -e DECRYPTION_PASSPHRASE=$DECRYPTION_PASSPHRASE -e PKG=$3"
